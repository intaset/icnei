...
<p class="body" style="text-align:center!important; color: #FFF!important;">ICNEI'18 is part of the <b>3<sup>rd</sup> World Congress on Recent Advances in Nanotechnology (RAN'18)</b>.<br>For more information about the congress, please visit the website here: <a href="http://rancongress.com/" class="body-link">www.rancongress.com</a>.</p>
  ...
  <div>
      ...
      <p class="body">ICNEI attracts a wide range of researchers in the field of nanotechnology and environmental issues. As a prominent company in the field of nanotechnology and environmental issues, we would like to offer you an exhibit at ICNEI. Please visit <a href="../events" class="body-link">Events</a> for more information.</p>
    </div>
  </div>
    </div>
  </div>
