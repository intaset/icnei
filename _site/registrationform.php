<?php
$my_email = "registration@icnei.com";
$errors = array();
...
Thank you for registering for ICNEI 2018. If you have requested any official letters, please allow up to 5 business days to receive your documents.

If you are an author, please make sure to send us the final version of your paper and a signed copyright form via email to info@icnei.com. You can find the copyright form here: www.icnei.com/papers. Please note that failing to do so may result in an unsuccessful process of your registration.

To reserve a room with a DISCOUNTED price, please fill out the provided booking form here: www.icnei.com/accommodation/#Novotel

You can find your registration details below. If there are any errors in the information you have provided, please write an email to us at registration@icnei.com mentioning the correct information. Please note that you SHOULD NOT refill the form.
...
$your_subject = "Your Registration Details for ICNEI'18";

$your_headers = "From: ICNEI'18 <" . $my_email . ">";
...
<meta name="description" content="Thank you for filling out the registration form!">
<meta name="keywords" content="environmental issues, nanoenergy, nanotechnology and safety issues, nanotechnology standard, nanotechnology and health issues, nanomaterials toxicity, nanotechnology and education, nanotechnology and ethical impacts, environmental issues conference, nanoenergy conference, nanotechnology and safety issues conference, nanotechnology standard conference, nanotechnology and health issues conference, nanomaterials toxicity conference, nanotechnology and education conference, nanotechnology and ethical impacts conference, nanotechnology, nanotechnology conference">
<title>ICNEI'18 - Registration Form Filled!</title>
  ...
  <div class="cbp-af-inner">
    <div class="unit unit-s-3-4 unit-m-1-3 unit-l-1-3">
      ...
      <div class="unit unit-s-1-3 unit-m-2-3 unit-m-2-3-1 unit-l-2-3">
        ...
        <div class="bg">
          <h1>3<sup>rd</sup> International Conference on Nanotechnology<br>and Environmental Issues (ICNEI'18)</h1>
...
<p class="body" style="text-align:center!important;">ICNEI'18 is part of the <b>3<sup>rd</sup> World Congress on Recent Advances in Nanotechnology (RAN'18)</b>. For more information about the congress, please visit the website here: <a href="http://rancongress.com/" class="body-link">www.rancongress.com</a>.</p>
        </div>
    </div>
...
<p class="body" style="text-align:center!important; color: #FFF!important;">ICNEI'18 is part of the <b>3<sup>rd</sup> World Congress on Recent Advances in Nanotechnology (RAN'18)</b>.<br>For more information about the congress, please visit the website here: <a href="http://rancongress.com/" class="body-link">www.rancongress.com</a>.</p>
  ...
  <div class="unit unit-s-1 unit-m-1-3-1 unit-l-1-3-1">
    ...
    <div>
      <h2 class="title">1</h2>
      <p class="bold">ICNEI 2018:</p>
      <p class="body">ICNEI 2018 will be held in Budapest, Hungary on April 10 - 12, 2018 at the Novotel Budapest Centrum.</p>
      ...
      <br>
      <p class="body">As per popular request, the organizing committee has decided to extend the ICNEI'18 conference to three days (now April 10 - 12, 2018). The new high-level schedule is as follows:</p>
  ...
  <div>
      ...
      <p class="body">ICNEI attracts a wide range of researchers in the field of nanotechnology and environmental issues. As a prominent company in the field of nanotechnology and environmental issues, we would like to offer you an exhibit at ICNEI. Please visit <a href="../sponsor" class="body-link">Sponsors</a> for more information.</p>
    </div>
  </div>
    </div>
  </div>
...
<div class="unit unit-s-1 unit-m-1-4-1 unit-l-1-4-1">
  ...
  <p class="body">If you have requested any official invitation letters, please allow up to 5 business days to receive your documents.</p> 
    ...
    <p class="body">If there are any problems in the information you have filled out, please write an email to us at <a href="mailto:registration@icnei.com" class="body-link">registration@icnei.com</a> mentioning the mistakes made. Please note that you SHOULD NOT refill the form.</p>

  <p class="body">We are looking forward to seeing you at ICNEI'18!</p>
  </div>
</div>
...
<footer id="contact">
  ...
  <div class="unit-spacer">
    ...
    +1-613-695-3040<br>
    <a href="mailto:info@icnei.com">info@icnei.com</a></p>
    </div>
  </div>

  <div class="unit unit-s-1 unit-m-2-3 unit-l-2-3 contact">
  <div class="unit-spacer">
  <p class="body">For questions or comments regarding ICNEI'18, please fill out the form below:</p>
  ...
  <center class="full right cf"><div class="g-recaptcha" data-sitekey="6LcZ9g0TAAAAADmCwn5imYLjla8N8NsvObfY8mMt"></div></center>
  <div class="cf">
